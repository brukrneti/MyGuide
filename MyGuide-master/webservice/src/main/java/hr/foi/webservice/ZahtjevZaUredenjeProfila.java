...
public class ZahtjevZaUredenjeProfila extends StringRequest {
    ...
    public ZahtjevZaUredenjeProfila(Integer id_korisnik, String korisnicko_ime, String lozinka, String ime, String prezime, String img_name, String img_path,Response.Listener<String> listener){
